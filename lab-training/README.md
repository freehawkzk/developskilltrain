...
| 模块 | 主题 | 课时 | 编程能力目标 |
|------|------|------|-------------|
| 模块0 | Python编程基础 | 1个上午×3h = 3h | 能读懂 |
| 模块1 | Linux基本使用与深度学习环境搭建 | 1个上午×3h = 3h | 能读懂 |
| 模块2 | 深度学习入门 | 1个上午×3h = 3h | 能修改 |
| 模块3 | 面向声音的分类模型 | 1个上午×3h = 3h | 能修改→能组合 |
| 模块4 | DeepACE模型解析 | 1个上午×3h = 3h | 能组合 |
| 模块5 | DeepFilterNet模型解析 | 1个上午×3h = 3h | 能组合 |
| 模块6 | ASR技术简介 | 1个上午×3h = 3h | 能构建 |
